...
cover: 
olid: OL44567676M # use Open Library ID to fetch cover (if no `cover` is provided)
isbn: 9669422876 # use ISBN to fetch cover (if no `olid` is provided, dashes are optional)
categories:
tags: 
buy_link: 
started: 2025-01-30
